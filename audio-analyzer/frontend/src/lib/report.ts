...
<body>
  <div class="wrap">
    <header>
      <div class="brand">RTAI — Real-Time Audio Intelligence · Measurement Report</div>
      <h1>${title}</h1>
    ...
    <footer>Generated by RTAI — Real-Time Audio Intelligence · heuristic, offline diagnostics · ${when}</footer>
  </div>
</body>
</html>`;
}
